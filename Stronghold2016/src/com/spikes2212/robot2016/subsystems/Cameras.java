...
public class Cameras extends Subsystem {
	...
	public final NIVision.Range rRange = new NIVision.Range(0, 255);
	public final NIVision.Range gRange = new NIVision.Range(0, 255);
	public final NIVision.Range bRange = new NIVision.Range(0, 255);
