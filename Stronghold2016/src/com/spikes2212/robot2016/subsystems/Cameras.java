...
public class Cameras extends Subsystem {
	...
	private final double CAMERA_ANGLE = 21;
	private final double TARGET_HEIGHT = 80;
	...
	public final NIVision.Range rRange = new NIVision.Range(254, 255);
	public final NIVision.Range gRange = new NIVision.Range(254, 255);
	public final NIVision.Range bRange = new NIVision.Range(254, 255);
