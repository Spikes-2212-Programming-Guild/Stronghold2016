...
public class FixedPIDStraightDriveDistanceWithGyro extends DoublePIDCommand {
	...
	private static final double KI_STRAIGHT = 0;
	private static final double KD_STRAIGHT = 0;
	private static final double KP_TURN = 1;
	private static final double KI_TURN = 0;
	private static final double KD_TURN = 0;
	private static final double TOLERANCE_STRAIGHT = 1;
	private static final double TOLERANCE_TURN = 0;

	public FixedPIDStraightDriveDistanceWithGyro(double distance) {
